...
const AllUsers = () => {
  ...
  const handleUpdate = async () => {
    try {
      const { data } = await axios.put(
        `${server}/user/admin/update-user/${selectedUser.id}`,
        {
          name,
          email,
          phoneNumber,
  ...
  const handleAdd = async () => {
    ...
    try {
      const { data } = await axios.post(`${server}/user/admin/create-user`, formData, {
        withCredentials: true,
    ...
    <div className="w-full flex justify-center pt-5">
      <div className="w-[97%]">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-5 gap-4">
          <h3 className="text-[22px] font-Poppins">All Users</h3>
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
            ...
            />
            <button
              className={`${styles.button} text-white text-[16px] !h-[42px]`}
            ...
            <div className="w-[95%] 800px:w-[40%] min-h-[20vh] bg-white rounded shadow p-5">
              ...
              <div className="w-full flex items-center justify-center">
                ...
                <div
                  ...
                  onClick={() => setOpenDelete(false) || handleDelete(userId, selectedRole)}
                >
                  confirm
                </div>
              </div>
        ...
        {openEdit && (
          <div className="w-full fixed top-0 left-0 z-[999] bg-[#00000039] flex items-center justify-center h-screen">
            <div className="w-[95%] 800px:w-[40%] bg-white rounded shadow p-5">
              ...
              <h3 className="text-[25px] text-center py-5 font-Poppins text-[#000000cb]">Edit User</h3>
        ...
        {openAdd && (
          <div className="w-full fixed top-0 left-0 z-[999] bg-[#00000039] flex items-center justify-center h-screen">
            <div className="w-[95%] 800px:w-[40%] bg-white rounded shadow p-5">
              <div className="w-full flex justify-end cursor-pointer">
                <RxCross1 size={25} onClick={() => setOpenAdd(false)} />
              </div>
